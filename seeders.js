...
//
//   npx bare seeders.js pear://<keet-app-key> [app-name]
//   npx bare seeders.js <64-hex-or-z32-hypercore-key> [app-name]
//
...
if (!arg) {
  console.error('usage: npx bare seeders.js <pear://link | hypercore-key> [app-name]')
  process.exit(1)
}
